package com.elsaticSearch.elk.config;
/*
 * package com.elsaticSearch.elk;
 *
 ...
 *
 * @Configuration public class RestClientConfig extends
 ...
 *
 * @Bean public ElasticsearchOperations esearchTemplate() { return new
